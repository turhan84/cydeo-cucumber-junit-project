...
Feature: Some of the general functionality verifications
  ...
  Scenario: Order placement scenario
    ...
    And user enters customer name "Maris spoon"
    ...
    Then user should see "Maris spoon" in the first row of the web table
  ...
  Scenario Outline: Order placement scenario
    ...
    Examples:
     ...
     # | 2        | Jane Doe     | 7th st | NY   | NY    | 99999 | Visa        | 1111222233334444 | 12/25   | Jane Doe     |
     # | 5        | Jack Doe     | 7th st | NY   | NY    | 99999 | Visa        | 1111222233334444 | 12/25   | Jack Doe     |
    # | 6        | Jen Doe      | 7th st | NY   | NY    | 99999 | Visa        | 1111222233334444 | 12/25   | Jen Doe      |
    # | 7        | Mike Doe     | 7th st | NY   | NY    | 99999 | Visa        | 1111222233334444 | 12/25   | Mike Doe     |
    # | 8        | Mary Doe     | 7th st | NY   | NY    | 99999 | Visa        | 1111222233334444 | 12/25   | Mary Doe     |
